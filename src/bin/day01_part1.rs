...
/// Entry point for Advent of Code Day 1, Part 1.
///
/// This binary reads the puzzle input and executes the solver function for Day 1, Part 1.
...
fn main() {
    run_puzzle(1, 1, None, solve).expect("failed to run puzzle");
}
